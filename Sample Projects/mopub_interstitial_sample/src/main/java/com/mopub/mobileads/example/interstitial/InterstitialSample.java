...
public class InterstitialSample extends Activity {
	...
	private class SampleListener implements InterstitialAdListener {
		...
		public void onInterstitialLoaded(MoPubInterstitial interstitial) {
			...
			Toast.makeText(InterstitialSample.this, "onInterstitialLoaded", Toast.LENGTH_SHORT).show();
		...
		public void onInterstitialShown(MoPubInterstitial interstitial) {
			...
			Toast.makeText(InterstitialSample.this, "onInterstitialShown", Toast.LENGTH_SHORT).show();
		}
		...
		public void onInterstitialClicked(MoPubInterstitial interstitial) {
			...
			Toast.makeText(InterstitialSample.this, "onInterstitialClicked", Toast.LENGTH_SHORT).show();
		}
		...
		public void onInterstitialDismissed(MoPubInterstitial interstitial) {
			...
			Toast.makeText(InterstitialSample.this, "onInterstitialDismissed", Toast.LENGTH_SHORT).show();
		}
	}
}
